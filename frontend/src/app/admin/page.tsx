...
export default function AdminPage() {
  ...
  // AI Auto-Generate Templates
  const autoGenerateTemplates = async () => {
    setIsGenerating(true);
    try {
      console.log(`🤖 [Admin] AI 템플릿 생성 요청: category=${selectedCategory}, count=${generateCount}`);
      
      const response = await fetch(`${API_BASE_URL}/api/admin/templates/auto-generate`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
      ...
      if (response.ok && data.success) {
        console.log(`✅ [Admin] AI 템플릿 생성 완료:`, data);
        alert(`✨ ${data.count}개의 템플릿이 자동 생성되었습니다!`);
        
        // 템플릿 리스트 새로고침
        await fetchTemplates();
        setIsAutoGenerateDialogOpen(false);
      } else {
        console.error("Failed to auto-generate:", data);
        alert(`생성 실패: ${data.detail || "알 수 없는 오류"}`);
      }
    } catch (error) {
      console.error("Failed to auto-generate templates:", error);
      alert("네트워크 오류가 발생했습니다.");
    } finally {
          ...
          <TabsContent value="templates" className="mt-6">
            <Card className="bg-[#1a1a1a] border-[#333]">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-white">프롬프트 템플릿</CardTitle>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Dialog open={isAutoGenerateDialogOpen} onOpenChange={setIsAutoGenerateDialogOpen}>
                    ...
                    <DialogContent className="bg-[#1a1a1a] border-[#333]">
                      <DialogHeader>
                        <DialogTitle className="text-white">✨ AI 템플릿 자동 생성</DialogTitle>
                        <DialogDescription className="text-gray-400">
                          Gemini AI가 선택한 카테고리에 맞는 고품질 프롬프트 템플릿을 자동으로 생성합니다.
                        </DialogDescription>
                      </DialogHeader>
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <SelectContent className="bg-[#1a1a1a] border-[#333]">
                              ...
                              <SelectItem value="tech">📱 테크/전자제품</SelectItem>
                              <SelectItem value="food">🍕 음식/F&B</SelectItem>
                              <SelectItem value="travel">✈️ 여행/관광</SelectItem>
                              <SelectItem value="lifestyle">🏠 라이프스타일</SelectItem>
                              <SelectItem value="education">📚 교육/강의</SelectItem>
                              <SelectItem value="sports">⚽ 스포츠/피트니스</SelectItem>
                              <SelectItem value="real_estate">🏢 부동산/인테리어</SelectItem>
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(val) => setGenerateCount(parseInt(val))}
                          >
                            <SelectTrigger className="bg-[#0a0a0a] border-[#333] text-white">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent className="bg-[#1a1a1a] border-[#333]">
                              ...
                              <SelectItem value="10">10개 (최대)</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        ...
                        <div className="p-3 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                          <p className="text-sm text-purple-300">
                            💡 생성되는 템플릿에는 다음이 포함됩니다:
                          </p>
                          <ul className="text-xs text-gray-400 mt-2 space-y-1">
                            <li>• High quality, 4K, Cinematic lighting</li>
                            <li>• {"{product_name}"}, {"{brand_name}"} 등 동적 변수</li>
                            <li>• Kling AI/Veo 최적화 영어 프롬프트</li>
                          </ul>
                        </div>
                      </div>
